...
class Env(tk.Tk):
    ...
    def load_images(self):
        rectangle = PhotoImage(
            Image.open("C:/Users/dldls/OneDrive/바탕 화면/2학기 수업자료/강화학습/소스코드/7-1/그리드월드/img//rectangle.png").resize((30, 30)))
        triangle = PhotoImage(
            Image.open("C:/Users/dldls/OneDrive/바탕 화면/2학기 수업자료/강화학습/소스코드/7-1/그리드월드/img/triangle.png").resize((30, 30)))
        circle = PhotoImage(
            Image.open("C:/Users/dldls/OneDrive/바탕 화면/2학기 수업자료/강화학습/소스코드/7-1/그리드월드/img/circle.png").resize((30, 30)))
